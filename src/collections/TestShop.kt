...
val appCode = Product("AppCode", 24.0)
val phpStorm = Product("PhpStorm", 534.0)
val pyCharm = Product("PyCharm", 12.0)
val rubyMine = Product("RubyMine", 123.0)
val webStorm = Product("WebStorm", 52.0)
val teamCity = Product("TeamCity", 524.0)
val youTrack = Product("YouTrack", 24.0)
...
val sortedCustomers = listOf(cooper, nathan, bajram, asuka, lucas, riku).map { customers[it] }
